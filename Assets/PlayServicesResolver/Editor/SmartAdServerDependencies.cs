// <copyright file="SmartAdServerDependencies.cs" company="Smart AdServer">
...
[InitializeOnLoad]
public static class SmartAdServerDependencies
{
    private static readonly string PluginName = "SmartAdServer";
